...
permutationClusteringSWP(group="docker", scratch.folder=getwd(), file=file, percent=10, nCluster=nCluster, separator="\t", logTen=0, clustering="griph", seed=111, index=index)
#cambia \t
