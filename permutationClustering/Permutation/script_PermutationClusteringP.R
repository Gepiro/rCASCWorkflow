...
permutationClusteringSWP(group="docker", scratch.folder=getwd(), file=file, percent=10, nCluster=nCluster, separator=",", logTen=0, clustering="SIMLR", perplexity=10 , seed=111, rK=0, index=index)
#cambia \t
