...
#' @param nCluster, first number of cluster for k means algorithm
...
#' @examples
#' \dontrun{
#'  permutationClusteringSW("docker","/home/lucastormreig/CASC2.0/permutationClustering/scratch/","/home/lucastormreig/CASC2.0/permutationClustering/Data/TOTAL.csv",4,2,10,3,4,separator=",",logTen=0,clustering="SIMLR")
#'}
#' @export
permutationClusteringSWP <- function(group=c("sudo","docker"), scratch.folder, file, percent, nCluster, separator, logTen=0, clustering, perplexity=10 , seed=1111, rK=0, index=1){
...
system(paste("cp ",data.folder,"/",matrixName,".",format," ",scrat_tmp.folder,"/",matrixName,sep=""))
  ...
  #executing the docker job
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d docker.io/repbioinfo/permutationclusteringsw Rscript /home/permutation.R ",percent, " ",matrixName," ",format," ",separator," ",logTen," ",clustering," ", nCluster, " ",rK," ",perplexity, " ", index,sep="")
