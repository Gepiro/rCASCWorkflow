...
#'}
#' @export
permutationClusteringSW <- function(group=c("sudo","docker"), scratch.folder, file,nCluster, separator, logTen=0, clustering, perplexity=10 , seed=1111, rK=0){
...
system(paste("cp ",data.folder,"/",matrixName,".",format," ",scrat_tmp.folder,"/",matrixName,sep=""))
  ...
  #executing the docker job
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d docker.io/repbioinfo/permutationclusteringsw Rscript /home/main.R ",matrixName," ",nCluster," ",format," ",separator," ",logTen," ",clustering," ",perplexity," ", seed, sep="")
